    	...
    	<input type="hidden" name="wiz_page" value="1">
       	<div class="row controls" style="margin-bottom:20px;">
      		<div style="margin-left:50px">
      			...
      			<span class="help-inline"><?php echo MG_Language::translate('Liquid Web SSD VPS & Cloud Dedicated'); ?></span></h3>
            <div style="margin-left:50px;"><?php echo MG_Language::translate('Choose this option if you want to resell Liquid Web\'s standard SSD VPS or Cloud Dedicated line.');?></div>
