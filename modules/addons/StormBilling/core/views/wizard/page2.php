...
?>
	...
	<div id="wizAccordion" class="accordion">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h4>
					<a data-toggle="collapse" data-parent="#wizAccordion" href="#collapse1"><?php echo MG_Language::translate('I have Liquid Web API credentials');?></a>
				</h4>
			</div>
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<h4>
					<a data-toggle="collapse" data-parent="#wizAccordion" href="#collapse2"><?php echo MG_Language::translate('Create a NEW Liquid Web API username and password for me');?></a>
				</h4>
			</div>
