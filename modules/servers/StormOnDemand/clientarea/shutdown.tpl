...
<div id="modcmdworking" style="display:none;text-align:center;"><img src="admin/images/loader.gif" /> &nbsp; Working...</div>
  <div id="op_action">
  <div class="alert alert-warning">Are you sure you want to shutdown this machine?</div>
  <form action="" method="post" style="margin-top: 10px">
      <input type="hidden" name="modaction" value="shutdown" />
      <input type="submit" id="op_submit" value="Yes, shutdown my machine" class="btn btn-success" style="float: left; {if $template eq "six" or $custom_template eq "YES"}style="float: left; margin-left: 290px"{else}style="float: left; margin-left: 250px"{/if}/>
