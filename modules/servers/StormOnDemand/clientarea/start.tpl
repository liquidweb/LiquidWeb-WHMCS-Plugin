...
<div id="modcmdworking" style="display:none;text-align:center;"><img src="admin/images/loader.gif" /> &nbsp; Working...</div>
  <div id="op_action">
    ...
    <form action="" method="post" style="margin-top: 10px">
        ...
        <input type="submit" id="op_submit" value="Yes, start my machine" class="btn btn-success" {if $template eq "six" or $custom_template eq "YES"}style="float: left; margin-left: 290px"{else}style="float: left; margin-left: 250px"{/if}/>
