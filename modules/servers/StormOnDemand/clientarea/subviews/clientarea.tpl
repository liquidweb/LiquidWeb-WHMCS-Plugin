...
<table class="table table-framed table table-condensed" style="width: 100%">
    ...
    <tr>
        <td>Status</td>
        <td id="server-status"><img src="modules/servers/StormOnDemand/assets/images/loading.gif" alt="Loading..."/></td>
    </tr>
</table>
...
{if $monitoring}
    <div id="server-bandwidth">
        <h5 style="text-align: left; overflow: hidden">
            ...
            <form action="" method="post" style="float: right">
                <select id="select-bandwidth-frequency" name="frequency">
        ...
        <div id="bandwidth-stats" style="margin-top: 10px">
            <p style="text-align: center"><img src="modules/servers/StormOnDemand/assets/images/loading.gif" alt="Loading..."/></p>
        </div>
    </div>
    <div id="server-health">
        <h5 style="text-align: left; overflow: hidden">
            Server Load
            <form action="" method="post" style="float: right">
                <select id="select-load-duration" name="duration">
