            ...
            <tr>
                ...
                <td>
                    <form action="" method="post" class="form-inline" style="margin: 0!important">
                        ...
                        <input type="submit" value="Restore" {if $template eq "six" or $custom_template eq "YES"}style="height:30px !important;"{/if}  class="restore btn btn-danger btn-small"/>
                    </form>
                </td>
            </tr>
        {/foreach}
            ...
            <tr>
                ...
                <td>
                    <form action="" method="post">
                        ...
                        <input type="submit" value="Restore" {if $template eq "six" or $custom_template eq "YES"}style="height:30px !important;"{/if} class="restore btn-danger btn" />
                    </form>
                </td>
            </tr>
        {/foreach}
