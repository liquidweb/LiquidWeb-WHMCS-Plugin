...
var pInterval = null;
 ...
 jQuery('a.send-ajax-req').each(function(){
 	jQuery(this).click(function(e){
 		...
 		jQuery(this).parent().append('<br/><span class="whait-loader"><img src="modules/servers/LiquidWebPrivateParent/assets/images/loading.gif"alt="loading..." class="preolader"/></span>');
