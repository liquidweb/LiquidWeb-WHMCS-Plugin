...
{/if}
    {if $buttons}
        <ul class="storm-menu">
            <div style="overflow: auto; padding: 4px 0;">
                <a style="width: 15%" class="btn btn-success" href="clientarea.php?action=productdetails&id={$params.serviceid}&modop=custom&a=clientStart"> <i style="background-image: url('modules/servers/LiquidWebPrivateParent/assets/images/glyphicons-halflings.png') !important;" class="icon-arrow-up"></i> Start</a>
                <a style="width: 15%" class="btn btn-danger" href="clientarea.php?action=productdetails&id={$params.serviceid}&modop=custom&a=clientShutdown"> <i style="background-image: url('modules/servers/LiquidWebPrivateParent/assets/images/glyphicons-halflings.png');" class="icon-arrow-down"></i> Shutdown</a>
                <a style="width: 15%" class="btn btn-warning" href="clientarea.php?action=productdetails&id={$params.serviceid}&modop=custom&a=clientReboot"> <i style="background-image: url('modules/servers/LiquidWebPrivateParent/assets/images/glyphicons-halflings.png');" class="icon-refresh"></i> Reboot</a>
                <a style="width: 15%" class="btn btn-primary" href="clientarea.php?action=productdetails&id={$params.serviceid}&modop=custom&a=restore"> <i style="background-image: url('modules/servers/LiquidWebPrivateParent/assets/images/glyphicons-halflings.png');" class="icon-repeat"></i> Restore</a>
                <a style="width: 15%" class="btn btn-info" href="clientarea.php?action=productdetails&id={$params.serviceid}&modop=custom&a=history"> <i style="background-image: url('modules/servers/LiquidWebPrivateParent/assets/images/glyphicons-halflings.png');" class="icon-list-alt"></i> History</a>
            </div>
    ...
    <table class="table table-framed table table-condensed" style="width: 100%">
        ...
        <tr>
            <td>Status</td>
            <td id="server-status"><img src="modules/servers/LiquidWebPrivateParent/assets/images/loading.gif" alt="Loading..."/></td>
        </tr>
    </table>
    ...
    {if $monitoring} 
        <div id="server-bandwidth">
            ...
            <div id="bandwidth-stats" style="margin-top: 10px">
                <p style="text-align: center"><img src="modules/servers/LiquidWebPrivateParent/assets/images/loading.gif" alt="Loading..."/></p>
            </div>
        </div>  
