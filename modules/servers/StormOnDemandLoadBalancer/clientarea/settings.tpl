    ...
    <script type="text/javascript">
        $(function(){
            ...
            $("#add_service").click(function(event){
                ...
                $("#table_service tbody").append('<tr><td><input type="text" name="services['+max+'][src_port]" value=""/></td><td><input type="text" name="services['+max+'][dest_port]" value=""/></td><td><a href="javascript:void(0);" class="remove btn-default btn">Remove</a></td></tr>');
                if($("#table_service tbody tr").size() >= max_services && max_services)
                {
                    $("#add_service").hide();
            ...
            $("#add_new_node").click(function(){
                ...
                if(removed_first_row == false){
                    $("#table_node tbody tr").first().remove();
                    removed_first_row = true;
                }

                $("#table_node tbody").append("<tr><td class='node_domain'>"+host+"</td><td><input type='hidden' name='nodes["+t_max+"]' value='"+val+"' />"+val+"</td><td><a href='javascript:void(0);' class='remove_node btn btn-default'>Remove</a></td></tr>");
